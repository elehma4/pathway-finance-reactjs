...
export const Crypto = (props) => {
  return (
    ...
    <div className='w-full h-auto m-auto rounded-full flex items-center justify-center p-4'>
        <button className='bg-transparent text-lg hover:bg-gray-100 p-4 rounded-lg hover:scale-110 ease-in duration-300 w-full flex items-center justify-start mx-2 shadow-md font-semibold' id='BNB' onClick={() => props.onSelectSymbol('BNB')}><img src="/assets/BNB.png" alt='Bitcoin Dominance' className='w-10 rounded-full mr-3' />Binance</button>
    </div>
    <div className='w-full h-auto m-auto rounded-full flex items-center justify-center p-4'>
        <button className='bg-transparent text-lg hover:bg-gray-100 p-4 rounded-lg hover:scale-110 ease-in duration-300 w-full flex items-center justify-start mx-2 shadow-md font-semibold' id='ARB' onClick={() => props.onSelectSymbol('ARB')} ><img src="/assets/arbitrum.png" alt='Ethereum Dominance' className='w-10 rounded-full mr-3' />Arbitrum</button>
    </div>
    </>
  )
}
